...
public class Posttest3 extends javax.swing.JFrame {
    ...
    public void REGISTER(){
        ...
        if (nim.isEmpty()&&nama.isEmpty()&&jk.isEmpty()&&prodi.isEmpty()&&hobi.toString().isEmpty()&&alamat.isEmpty()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Posttest3.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
